...
public class Encrypted {
    ...
    /**
     * Serializes the object and encrypts the resulting binary data using the 
     * given key.
    ...
    /**
     * Decrypts the stored encrypted data using the given secret key and 
     * deserializes the resulting binary data to an object of given class.
     * @param key the secret key
